...
class FamilyMembersSelect extends StatefulWidget {
  @override
  _FamilyMembersSelectState createState() => _FamilyMembersSelectState();
}

class _FamilyMembersSelectState extends State<FamilyMembersSelect> {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(
        title: new Text("Lista familiares"),
          ...
          child: new GestureDetector(
            onTap: () => Navigator.of(context).push(
              new MaterialPageRoute(
                  builder: (BuildContext context) => new OptionsSymptomFamily(
                    list: list,
                    index: i,
                  )),
            ),
