...
class SymtomsMoveWidget extends StatefulWidget{
  @override
  _SymtomsMoveWidgetState createState() => _SymtomsMoveWidgetState();
}

class _SymtomsMoveWidgetState extends State<SymtomsMoveWidget>{
  ...
  getDataLastThree () async {
    var safe =  await _helperSgto.getThreeData("Incapacidad para hablar o moverse");
