...
class SymtomsDiarreaWidget extends StatefulWidget{
  @override
  _SymtomsDiarreaWidgetState createState() => _SymtomsDiarreaWidgetState();
}

class _SymtomsDiarreaWidgetState extends State<SymtomsDiarreaWidget>{
  ...
  getDataLastThree () async {
    var safe = await _helperSgto.getThreeData("Diarrea");
