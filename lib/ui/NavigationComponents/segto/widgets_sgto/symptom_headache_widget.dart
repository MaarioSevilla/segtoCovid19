...
class SymtomsHeadacheWidget extends StatefulWidget{
  @override
  _SymtomsHeadacheWidgetState createState() => _SymtomsHeadacheWidgetState();
}

class _SymtomsHeadacheWidgetState extends State<SymtomsHeadacheWidget>{
  ...
  getDataLastThree () async {
    var safe = await await _helperSgto.getThreeData("Dolor de cabeza");
                        ...
                        Expanded(
                          child: RichText(
                            text: TextSpan(
                              ...
                              children: [
                                TextSpan(
                                  text: "Historial de Dolor de cabeza \n\n",
