...
class SymtomsPainGargantaWidget extends StatefulWidget{
  @override
  _SymtomsPainGargantaWidgetState createState() => _SymtomsPainGargantaWidgetState();
}

class _SymtomsPainGargantaWidgetState extends State<SymtomsPainGargantaWidget>{
  ...
  getDataLastThree () async {
    var safe =await _helperSgto.getThreeData("Dolor de garganta");
