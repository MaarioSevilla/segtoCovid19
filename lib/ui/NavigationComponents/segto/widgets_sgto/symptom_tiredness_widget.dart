...
class SymtomsCansancioWidget extends StatefulWidget{
  @override
  _SymtomsCansancioWidgetState createState() => _SymtomsCansancioWidgetState();
}

class _SymtomsCansancioWidgetState extends State<SymtomsCansancioWidget>{
  ...
  getDataLastThree () async {
    var safe = await _helperSgto.getThreeData("Cansancio");
