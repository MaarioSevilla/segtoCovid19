...
class SymtomsAirWidget extends StatefulWidget{
  @override
  _SymtomsAirWidgetState createState() => _SymtomsAirWidgetState();
}

class _SymtomsAirWidgetState extends State<SymtomsAirWidget>{
  ...
  getDataLastThree () async {
    var safe = await _helperAir.getDataThree();
