...
class SymtomsConjuntivitisWidget extends StatefulWidget{
  @override
  _SymtomsConjuntivitisWidgetState createState() => _SymtomsConjuntivitisWidgetState();
}

class _SymtomsConjuntivitisWidgetState extends State<SymtomsConjuntivitisWidget>{
  ...
  getDataLastThree () async {
    var safe = await _helperSgto.getThreeData("Conjuntivitis");
