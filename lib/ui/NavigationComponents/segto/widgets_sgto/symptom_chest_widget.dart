...
class SymtomsPechoWidget extends StatefulWidget{
  @override
  _SymtomsPechoWidgetState createState() => _SymtomsPechoWidgetState();
}

class _SymtomsPechoWidgetState extends State<SymtomsPechoWidget>{
  ...
  getDataLastThree () async {
    var safe = await _helperSgto.getThreeData("Dolor o presión en el pecho");
