...
class SymtomsRashWidget extends StatefulWidget{
  @override
  _SymtomsRashWidgetState createState() => _SymtomsRashWidgetState();
}

class _SymtomsRashWidgetState extends State<SymtomsRashWidget>{
  //erupciones cutaneas
  ...
  getDataLastThree () async {
    var safe = await _helperSgto.getThreeData("Erupciones cutáneas");
                        ...
                        Expanded(
                          child: RichText(
                            text: TextSpan(
                              ...
                              children: [
                                TextSpan(
                                  text: "Historial de Erupciones cutáneas \n\n",
