...
class SymtomsSmellWidget extends StatefulWidget{
  @override
  _SymtomsSmellWidgetState createState() => _SymtomsSmellWidgetState();
}

class _SymtomsSmellWidgetState extends State<SymtomsSmellWidget>{
  ...
  getDataLastThree () async {
    var safe = await _helperSgto.getThreeData("Pérdida del sentido del olfato");
