...
class SymtomsTosWidget extends StatefulWidget{
  @override
  _SymtomsTosWidgetState createState() => _SymtomsTosWidgetState();
}

class _SymtomsTosWidgetState extends State<SymtomsTosWidget>{
  ...
  getDataLastThree () async {
    var safe = await _helperTos.getDataLastThree();
