...
class UpdateSymtom extends StatefulWidget {

  final List list;
  final int index;

  UpdateSymtom({this.list, this.index});

  @override
  _UpdateSymtomState createState() => _UpdateSymtomState();
}

class _UpdateSymtomState extends State<UpdateSymtom> {
  ...
  iniciarVariables(){
    if(sintoma=='Dificultad para respirar'){
      _finalId = widget.list[widget.index]['idSegtoAire'].toString();
      _finalMatricula = widget.list[widget.index]['iSAMatricula'].toString();
    }else if(sintoma=='Tos seca'){
      _finalId = widget.list[widget.index]['idSegtoTos'].toString();
      _finalMatricula = widget.list[widget.index]['iSTMatricula'].toString();
    }else{
      _finalId = widget.list[widget.index]['idSgtoSintomas'].toString();
      _finalMatricula = widget.list[widget.index]['iMatricula'].toString();
    }

    _valueReal = widget.list[widget.index]['gravedad'].toString();
    ...
    timeFrom = widget.list[widget.index]['fechaHora'].toString();
                    ...
                    children: <Widget>[
                      ...
                      new RaisedButton(
                        onPressed : () async {
                          ...
                          if(sintoma=="Tos seca"){
                            print("table tos");
                            await _helperTos.editarData(_finalId,_finalMatricula,_valueReal,_finalTime);
                          }else if(sintoma=="Dificultad para respirar"){
                            print("table aire");
                            await _helperAir.editarData(_finalId,_finalMatricula,_valueReal,_finalTime);
                          }else{
                            print("table sgto");
                            await _helperSgto.editarData(_finalId,_finalMatricula,sintoma,_valueReal,_finalTime);
                          }
                        },
                        shape: RoundedRectangleBorder(
